        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="relative z-10">
            ...
            <h1 className="hero-reveal opacity-0 translate-y-8 transition-all duration-700">
              <span className="block font-display text-5xl md:text-display-lg lg:text-display-xl font-light italic text-ink dark:text-mist leading-none mb-2 sm:whitespace-nowrap">
                Transform Your Body
              </span>
              <span className="block font-display text-5xl md:text-display-lg lg:text-display-xl font-semibold text-forest dark:text-forest-light leading-none sm:whitespace-nowrap">
                Elevate Your Life
              </span>
            </h1>
            ...
            {/* CTA Row */}
            <div className="hero-reveal opacity-0 translate-y-8 transition-all duration-700 flex flex-col sm:flex-row gap-4 mt-10">
              <a
                href="#contact"
            ...
            {/* Stats */}
            <div className="hero-reveal opacity-0 translate-y-8 transition-all duration-700 flex flex-col sm:flex-row gap-6 sm:gap-8 mt-12 pt-8 border-t border-ink/8 dark:border-mist/8">
          ...
          <div className="hero-reveal opacity-0 translate-y-8 transition-all duration-700 relative flex justify-center lg:justify-end">
            <div className="relative">
              {/* Main image frame */}
              <div className="relative w-full max-w-[320px] sm:w-80 h-96 lg:w-96 lg:h-[28rem]">
                ...
                <div className="relative w-full h-full rounded-5xl overflow-hidden shadow-soft-lg">
                  <Image src="/gowthami_hero_updated.jpeg" alt="Hero" fill priority className="object-cover" sizes="(max-width: 640px) 320px, 400px" />
                </div>
              </div>

              {/* Floating cards */}
              <div className="absolute -left-4 sm:-left-8 top-12 animate-float" style={{ animationDelay: '1s' }}>
              ...
              <div className="absolute -right-2 sm:-right-6 bottom-16 animate-float-delayed">
